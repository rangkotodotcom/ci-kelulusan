                                ...
                                <tr>
                                    <td class="content-cell" style="word-break: break-word; font-family: &quot;Nunito Sans&quot;, Helvetica, Arial, sans-serif; font-size: 16px; padding: 45px;">
                                        <div class="f-fallback">
                                            ...
                                            <p style="font-size: 16px; line-height: 1.625; color: #51545E; margin: .4em 0 1.1875em;">Sehubung dengan permintaan anda untuk mengirimkan No Peserta UNBK di sistem <?= $web; ?>. </p>
                                            <p style="font-size: 16px; line-height: 1.625; color: #51545E; margin: .4em 0 1.1875em;">Maka kami mengirimkan anda dengan rincian:</p>
                                            ...
                                            <p>Silahkan gunakan No Peserta tersebut untuk melihat kelulusan di system <?= $web; ?></p>
