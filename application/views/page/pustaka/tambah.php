...
<ol class="breadcrumb">
    ...
    <li class="breadcrumb-item">
        <a href="<?= base_url('page/pustaka'); ?>">Bebas Pustaka</a>
    </li>
...
<div class="card mb-3">
    <div class="card-header">
        ...
        Form Tambah Bebas Pustaka</div>
    <div class="card-body">
        <div class="table-responsive">
            <table class="table table-bordered" width="100%" cellspacing="0">
                <form action="<?= base_url('page/pustaka/add'); ?>" method="post" enctype="multipart/form-data">
