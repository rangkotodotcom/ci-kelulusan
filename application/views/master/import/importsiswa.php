...
<div class="row">
    <div class="col-lg-6">
        <a href="<?= base_url('master/importsiswa/downloadformat') ?>" class="btn btn-primary mb-3">
            <i class="fa fa-fw fa-download"></i> Download Format
        </a>
        <form action="<?= base_url('master/importsiswa/upload') ?>" method="post" enctype="multipart/form-data">
