...
$rata_rata_r = round(($total_r / 14), 2);
...
$rata_rata_us = round(($total_us / 14), 2);
...
<body>
    ...
    <div class="content">
        <h4 align="center"><u><b><?= $blangkosurat['nama_surat'] ?></b></u><br><span style="font-size:10px;">NOMOR : <?= $blangkosurat['nomor_surat'] ?></span></h4>

        <p style="font-size:12px;">Kepala <?= $profilsekolah['nama_sekolah']; ?> selaku Ketua Penyelenggara Ujian Sekolah Tahun Pelajaran <?= $profilsekolah['tahun_ajaran']; ?> berdasarkan:</p>

        <ol style="font-size:12px; margin-top:-50px;">
            ...
            <li>Rapat Pleno Dewan Pendidik tentang Kelulusan pada tanggal 23 April 2020</li>
        </ol>
        <p style="font-size:12px; display:inline;">Menerangkan bahwa:</p>
        ...
        <table width="100%" cellspacing="0" cellpadding="1" border="1" style="text-align:center; border:2px solid; font-size:12px;">
            ...
            <tr style="background-color:#d3d3d3">
                ...
                <th style="text-align: center;">USBN BK/KP</th>
            </tr>
            <tr style="background-color:#d3d3d3">
            ...
            <tr style="background-color:#d3d3d3; font-weight:bold;">
                ...
                <td><b><?= $rata_rata_r ?></b></td>
                <td><b><?= $rata_rata_us ?></b></td>
            </tr>
        </table>
    </div>
