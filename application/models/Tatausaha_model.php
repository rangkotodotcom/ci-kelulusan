...
class Tatausaha_model extends CI_Model
{
    ...
    public function save()
    {
        ...
        $data = [
            'kegiatan' => 'Tambah Siswa Bebas TU (' . $this->no_pes = $post["no_pes"] . ')',
    ...
    public function update()
    {
        ...
        $this->no_pes = $post["no_pes"];
        $this->komite = '1';
        $this->db->update($this->_table, ["komite" => $this->komite], array("no_pes" => $post['no_pes']));
    ...
    {
        $data = [
            'kegiatan' => 'Hapus Siswa Bebas TU (' . $no_pes . ')',
            'oleh' => $this->session->userdata('email'),
            'waktu' => NULL
        ];
        ...
        $this->komite = '0';
        return $this->db->update($this->_table, ["komite" => $this->komite], array("no_pes" => $no_pes));
    }
}
